...
class TestDualPathConstructionParity(unittest.TestCase):
    ...
    def test_subclasses_store_same_frozen_config_object(self):
        ...
        dual_path_scheduler_fields = {
            ...
            "_prefill_pending_reverse_receive_failure_terminals",
            "_prefill_staged_or_delivered_reverse_terminals",
            "_prefill_control_failures",
            "_prefill_control_endpoint",
            "_prefill_abort_request_ids",
            "_scheduler_side_finished_recving",
            "_decode_control_failures",
            "_decode_late_abort_contexts",
            "_prefill_observed_reverse_admission_terminals",
            "_prefill_delivery_futures",
            "_prefill_delivery_records",
            "_prefill_invalid_request_keys",
            "_block_pool",
            "_completion_tracker",
            "_expected_worker_count",
            "_pending_finished_sending",
            "_pending_finished_recving",
        ...
        self.assertEqual(
            ...
            | {
                ...
                "_pending_reverse_receive_failure_terminals",
    ...
    def test_dual_path_classes_define_only_contracted_methods(self):
        ...
        expected_methods = {
            ...
            "DualPathConnectorWorker": {
                ...
                "_release_split_request_state",
                "_release_finished_reverse_terminals",
                "_consume_reverse_receive_binding",
                "_consume_reverse_receive_failure_terminal",
